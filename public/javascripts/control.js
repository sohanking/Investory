...
//    $(".frogImageMoods img").attr("src", $imgLink+frogMood+$imgExtension);
    ...
    $(".frogImage img, .feelingCircularMenu ul li").click(function(){
...
//              $("#mood span",this).css("background-color","#F2F5FB");
 ...
 $(".contentMood .page2, #goalIndicator, .contentMood .page4, .contentMood .page5").hide();
    ...
    $(".page1 .next, .page1 .skip").click(function(){ 
        ...
        $(".contentMood .page1,.contentMood .page3, #btm, .page3Sub").hide();
...
var once = true;
    ...
    $(".page2 .go").click(function(){ 
        ...
        if(once){
             $("#goalIndicator").append(" > Next Step");
        
         $(".contentMood .page3, .page3Sub").show();
...
//        
      ...
      $(".page2 .next").click(function(){ 
         ...
         $("#goalIndicator").append(" > Risk profiling");
   ...
   $("#goalIndicator").append(" > Your Plan");
